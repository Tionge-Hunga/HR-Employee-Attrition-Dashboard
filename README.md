...
These filters allow users to explore employee attrition patterns across different workforce groups.
...
- The organization had a headcount of **1,470 employees**.
- **237 employees** left the organization, resulting in an overall **16% attrition rate**.
- Male employees had a slightly higher attrition rate (**17%**) compared with female employees (**15%**).
- Employees who worked overtime had a substantially higher attrition rate (**31%**) compared with employees who did not work overtime (**10%**).
- The **Sales department** had the highest departmental attrition rate at **21%**.
- Employees with a **Bad work-life balance** had the highest attrition rate at **31%**.
- Employees with **Low job satisfaction** had an attrition rate of **23%**.
...
Data Analyst | Data Management | Monitoring & Evaluation Professional
